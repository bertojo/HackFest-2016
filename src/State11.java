...
public class State11 {
    public static void run(AvalonBot bot, Game game, Message message) {
        ...
        if(game.totalWinCount >= 3) {
            ...
            //assassin is found 
            bot.sendMessage(game.players.get(indexOfAssassin) + " is the Assassin! Please choose someone to be Merlin and fuck him!", message.getChatId());
            //need to insert keyboard here for the assassin to choose the character to be merlin 
        } else { 
            bot.sendMessage("LOYAL SERVANTS OF ARTHUR. YOU HAD ONE JOB AND YOU FUCKED UP.", message.getChatId());
        }
    }
